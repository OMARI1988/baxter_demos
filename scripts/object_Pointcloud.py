...
class object_detection():
    def __init__(self):
        ...
        pc_topic = rospy.resolve_name("") 
        rospy.Subscriber(pc_topic, sensor_msgs.msg.PointCloud2, self._pc)
    ...
    def _plot_results(self, img, fgmask):
        ...
        for count,cnt in enumerate(contour):
            ...
            cx = x+w/2
            cy = y+h/2
            cw = int(w*self.enlarge)
            ch = int(h*self.enlarge)
