...
class object_detection():
    ...
    def _xtion_depth(self,imgmsg):
        ...
        self.xtion_img_d.setflags(write=True)
        a1 = self.xtion_img_d>1000
        #a2 = self.xtion_img_d<1000
        self.xtion_img_d[a1] = 0
        fgmask = cv2.convertScaleAbs(self.xtion_img_d)
        self.xtion_img_d_rgb = cv2.cvtColor(fgmask,cv2.COLOR_GRAY2BGR)
